...
TextConfig::TextConfig(QWidget *parent) : QWidget(parent) {
    ...
    /*connect(fontsCB, SIGNAL(currentTextChanged(const QString &)),
    ...
    /*connect(m_strikeOutButton, SIGNAL(clicked(bool)),
            this, SLOT(fontStrikeOutChanged(const bool)));*/
    ...
    /*connect(m_strikeOutButton, SIGNAL(clicked(bool)),
                this, SLOT(fontUnderlineChanged(const bool)));*/
    ...
    /*connect(m_italicButton, SIGNAL(clicked(bool)),
            this, SLOT(fontItalicChanged(const bool)));*/
